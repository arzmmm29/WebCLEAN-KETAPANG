...
<head>
    <meta charset="utf-8" />
    <title>Log Out | Jidox - Material Design Admin & Dashboard Template</title>
    ...
    <!-- App css -->
    <link href="{{url('/')}}/admin-assets/assets/css/app.min.css" rel="stylesheet" type="text/css" id="app-style" />
            ...
            <div class="card-body d-flex flex-column h-100 gap-3">
                ...
                <div class="auth-brand text-center text-lg-start">
                    <a href="index.html" class="logo-dark">
                        <span><img src="{{url('/')}}/admin-assets/assets/images/logo-dark.png" alt="dark logo" height="24"></span>
                    </a>
                    <a href="index.html" class="logo-light">
                        <span><img src="{{url('/')}}/admin-assets/assets/images/logo.png" alt="logo" height="24"></span>
                    </a>
                </div>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Back to <a href="auth-login-2.html" class="text-muted ms-1"><b>Log In</b></a></p>
                </footer>
